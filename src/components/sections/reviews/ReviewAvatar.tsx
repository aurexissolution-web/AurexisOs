    ...
    case "cyan-violet":
      return (
        <SplitOrb
          id={id}
          size={size}
          leftStops={["#A0FFFF", "#00F0FF"]}
          rightStops={["#D8C8FF", "#A78BFA"]}
        />
      );
    case "amber-emerald":
      return (
        <SplitOrb
          id={id}
          size={size}
          leftStops={["#FFE4A0", "#F59E0B"]}
          rightStops={["#9FF3D0", "#10B981"]}
        />
      );
    case "silver":
      return (
