// src/components/sections/connect/ConnectManagementPlans.tsx
...
export function ConnectManagementPlans() {
  ...
  return (
    <section className="relative overflow-hidden px-6 py-12 md:py-14">
      <div
        ...
        style={{
          background: `radial-gradient(40% 45% at 85% 20%, ${accent(0.1)}, transparent 70%), radial-gradient(40% 50% at 5% 90%, rgba(${CONNECT_DEEP_RGB},0.18), transparent 70%)`,
        }}
      />
      <div
        aria-hidden
      ...
      <div className="relative mx-auto max-w-6xl">
        <div className="grid items-end gap-5 lg:grid-cols-[1.2fr_1fr]">
          <div>
            <ConnectSectionLabel>Management Plans</ConnectSectionLabel>
            <h2
          ...
          <p className="text-[15px] leading-[1.6] text-white/55 lg:pb-1.5">
            Monthly. A WhatsApp channel left alone drifts — templates expire, flows break when your
            services change, and campaigns stop performing. These plans keep it working and keep it
            selling.
          </p>
        </div>
                  ...
                  <span className="flex gap-1" aria-label={`Level ${level} of ${levels}`}>
                    {Array.from({ length: levels }, (_, i) => (
                      <span
                        ...
                        style={{
                          background: i < level ? CONNECT_ACCENT : 'rgba(255,255,255,0.12)',
                        }}
                      />
                    ))}
                  </span>
                ...
                <div className="mt-4 border-t border-white/[0.08] pt-4">
                  {inherits && (
                    <p
                      ...
                      style={{ background: accent(0.12), color: CONNECT_ACCENT }}
                    >
