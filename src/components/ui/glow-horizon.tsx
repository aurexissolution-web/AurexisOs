...
export default function GlowHorizonFM({ className, variant = "top" }: GlowHorizonProps) {
  ...
  return (
    ...
    >
      ...
      <Arc variant={variant} color="#5EE3DA" size="120%" initialOffset="10%" blur={31} delay={0.6} />
      <Arc variant={variant} color="#0A2E2C" size="124%" initialOffset="10%" blur={21} delay={0}   />
